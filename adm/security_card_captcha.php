...
<!-- 캡챠 적용 정책 -->
<div class="card">
    <div class="card-header" onclick="toggleCard('captcha-policy-section')">
        🤖 캡챠 적용 정책 <span id="captcha-policy-toggle">▶</span>
    </div>
    <div class="card-content" id="captcha-policy-section">
        ...
        <div class="extension-container">
            <div style="margin-bottom: 15px;">
                <span class="text-title-bold">게시판별 캡챠 적용 정책 현황</span>
            </div>

            <div style="display: flex; flex-direction: column; gap: 12px;">
                <?php foreach ($captcha_boards as $board): ?>
                <?php
                // 캡챠 카드에서는 캡챠 적용 여부만 판단
        ...
        <?php else: ?>
        <div class="success-container center-container" style="padding: 50px 20px;">
