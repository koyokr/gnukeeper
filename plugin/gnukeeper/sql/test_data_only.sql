-- 스팸 콘텐츠 탐지 테스트 데이터만 추가

-- 기존 테스트 데이터 삭제
DELETE FROM g5_security_spam_content_log WHERE sscl_ip LIKE '192.168.%' OR sscl_ip LIKE '211.45.%' OR sscl_ip LIKE '172.16.%' OR sscl_ip LIKE '10.0.%' OR sscl_ip LIKE '203.248.%' OR sscl_ip LIKE '61.78.%' OR sscl_ip LIKE '77.88.%' OR sscl_ip LIKE '155.201.%';
...
UPDATE g5_security_spam_keywords SET ssk_hit_count = 5 WHERE ssk_keyword = '룸사롱';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 4 WHERE ssk_keyword = '환전';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 4 WHERE ssk_keyword = '유흥';
...
UPDATE g5_security_spam_keywords SET ssk_hit_count = 3 WHERE ssk_keyword = '먹튀';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 3 WHERE ssk_keyword = '도우미';
...
UPDATE g5_security_spam_keywords SET ssk_hit_count = 2 WHERE ssk_keyword = '출장';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 2 WHERE ssk_keyword = '자위기구';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 2 WHERE ssk_keyword = '오나홀';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 1 WHERE ssk_keyword = '100%';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 1 WHERE ssk_keyword = '사이트';
UPDATE g5_security_spam_keywords SET ssk_hit_count = 1 WHERE ssk_keyword = '검증';