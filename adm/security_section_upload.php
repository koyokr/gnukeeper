    ...
    <div class="section-content" id="upload-policy-section">
        ...
        <div class="extension-container">
            <div style="margin-bottom: 15px;">
                <span style="font-weight: bold; font-size: 16px; color: #333;">게시판별 업로드 용량 정책 현황</span>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div style="flex: 1;">
                            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 8px;">
                                ...
                                <span style="background: #e2e8f0; color: #4a5568; padding: 2px 8px; border-radius: 4px; font-size: 12px; font-weight: bold;">
